...
floatHwPts = parseFloat(prompt("enter final HW pts (0-30):"));
//parseFloat(prompt("Please enter final HW pts (0-30):"));

floatMidPts = parseFloat(prompt("enter final Midterm pts (0-35)"));

floatFinPts = parseFloat(prompt("enter the points scored from the Final(0-35)"));

floatTotalPts = parseFloat(floatHwPts + floatMidPts + floatFinPts);

intGradeOption = parseInt(prompt("enter 1 for pass/fail or 2 "));
